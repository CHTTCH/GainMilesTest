...
# * {$DataBaseName}://{$UserName}:{$Password}@localhost:5433/gain_miles
# app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://GainMiles:GainMiles@localhost:5433/gain_miles'

# * For docker compose using
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://GainMiles:GainMiles@db:5432/compose_pg_for_ci_cd_practice'
